...
export const routes: Route[] = [
  ...
  },
  {
    ...
    description: 'Extrudes a circular cross-section into a 3D solid (IfcExtrudedAreaSolid + IfcCircleProfileDef).',
  ...
  },
  {
    ...
    description: 'Extrudes a rectangular hollow cross-section into a 3D solid (IfcExtrudedAreaSolid + IfcRectangleHollowProfileDef).',
  ...
  },
  {
    ...
    description: 'Extrudes a circular hollow cross-section into a 3D solid (IfcExtrudedAreaSolid + IfcCircleHollowProfileDef).',
  ...
  },
  {
    ...
    description: 'Extrudes an I-shaped cross-section into a 3D solid (IfcExtrudedAreaSolid + IfcIShapeProfileDef).',
  ...
  },
  {
    ...
    description: 'Extrudes an L-shaped cross-section into a 3D solid (IfcExtrudedAreaSolid + IfcLShapeProfileDef).',
  ...
  },
  {
    ...
    description: 'Extrudes a profile with an opening (IfcExtrudedAreaSolid + IfcArbitraryProfileDefWithVoids).',
